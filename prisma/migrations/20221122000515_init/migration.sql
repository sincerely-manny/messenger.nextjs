/*
  ...
  - You are about to drop the `AvatarToUser` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropIndex
DROP INDEX "AvatarToUser_userId_avatarId_key";

-- DropIndex
DROP INDEX "AvatarToUser_userId_idx";
